...
public class StudentMain {
	...
	public static void main(String[] args) {
		...
		Student1 std1 = new Student1(1,1,1,"hond");
		Student1.printCount();
		...
		std1.print();
		//Student.print(); //에러 발생. static이 print에는 안붙어서
		std2.print();
...
class Student1 {
	...
	private String name;
	//아래 생성자는 매개변수가 있고, 매개변수의 이름이 멤버변수와 같기때문에 
	//멤버 변수를 호출할때 this를 반드시 붙여야함.
