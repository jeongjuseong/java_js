...
public class LottoEx {
	...
	public static void main(String[] args ) {
		...
		// 로또 번호를 생성하고, 사용자가 번호를 입력하면 몇등인지 출력하는 코드를 작성
		
		
		//랜덤으로 로또번호 6개와 보너스번호 1개를 생성
		//7개짜리 배열에 로또번호를 생성하고, 앞에 6개는 로또번호, 마지막1개는 보너스로 활용
		int lotto[] = new int[7];
		//7개짤 배열에 로또번호를 생성
	...
	/**일치하는 개수와 보너스 번호와 사용자 번호가 일치하는 여부를 알려주면
	 * 등수를 출력하는 메서드
	 * 매개변수 : 일치하는 개수, 보너스번호와 일치여부
	...
	public static void printResult(int count, boolean checkBonus) {
		...
		case 3:
			...
			break;
		default:
			System.out.println("Loosing ticket!");
		}
	}
